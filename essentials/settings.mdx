...
<ResponseField name="api" type="API">
  ...
  <Expandable title="API">
    ...
    <ResponseField name="maintainOrder" type="boolean">
      Enabling this flag ensures that key ordering in API pages matches the key ordering defined in the API file.
...
<ResponseField name="api" type="string | string[]">
  ...
  <CodeGroup>
    ```json Absolute
    "api": "https://example.com/api.json"
    ```
    ```json Relative
    "api": "/api.json"
    ```
    ```json Multiple
    "api": ["https://example.com/api1.json", "/api2.json", "/api3.json"]
    ```
  </CodeGroup>
